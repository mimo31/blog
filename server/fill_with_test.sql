...
INSERT INTO article (name, url_name, time_created, filename, description, category_id)
	VALUES
		("test Euler's identity", "test_eulers_identity", 1656841113.0, "test_eulers_identity.html", "This article reveals a secret about a famous formula.", 1),
		("test Fibonacci numbers", "test_fibonacci", 1656841193.0, "test_fibonacci.html", "This article has been suggested by a friend from debating club.", 1);
